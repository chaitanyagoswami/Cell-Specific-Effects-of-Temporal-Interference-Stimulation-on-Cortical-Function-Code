...
plt.plot(np.arange(len(elec_location_ICMS))+1,fr_activ_pyr[:,0], 'x', label='Pure')
plt.plot(np.arange(len(elec_location_ICMS))+1,fr_activ_pyr[:,1], 'x', label='Modulated')
...
plt.plot(np.arange(len(elec_location_ICMS))+1,fr_activ_pv[:,2], 'x', label='Pure')
plt.plot(np.arange(len(elec_location_ICMS))+1,fr_activ_pv[:,3], 'x', label='Modulated')
